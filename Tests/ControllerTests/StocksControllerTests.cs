...
namespace Tests.ControllerTests
{
    public class StocksControllerTests
    {
        ...
        private readonly Mock<IFinnhubService> finnhubServiceMock;
        public StocksControllerTests()
        {
            finnhubServiceMock = new();
            finnhubService = finnhubServiceMock.Object;
        }
        #region Explore
        [Fact]
        public async Task Explore_NullStock()
        {
            ...
            var controller = new StocksController(finnhubService, tradingOptions);
            ...
            finnhubServiceMock.Setup(temp => temp.GetStocks()).ReturnsAsync(stocksDict);
